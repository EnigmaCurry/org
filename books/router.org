...
Create a new entry in your to your workstation's =~/.ssh/config= file
for the router VM.

#+begin_run
PROXMOX_IP_ADDRESS=X.X.X.X
cat &lt;&lt;EOF &gt;&gt; ~/.ssh/config
...
#+begin_stdout
3: lan: <NO-CARRIER,BROADCAST,MULTICAST,UP> mtu 1500 qdisc mq state DOWN mode DEFAULT group default qlen 1000
    link/ether CA:FE:BA:BE:12:34 brd ff:ff:ff:ff:ff:ff
