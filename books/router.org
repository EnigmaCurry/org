...
Connect your LAN clients to the physical lan interface of the VM.

*** Setup DHCP client

Most clients you simply need to plug the cable in and they will
automatically configure themselves by DHCP.

To make this explicit in systemd-networkd:
...
cat &lt;&lt;EOF > /etc/systemd/network/01-${INTERFACE}.link
[Match]
MACAddress=${MAC}
