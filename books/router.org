 ...
 * =ALIASES= (e.g., "router") is the list of aliases to setup for your
   Docker contexts.
...
cargo install --git https://github.com/EnigmaCurry/nifty-filter
#+end_run
...
This script includes the following config expressed as environment variables:
