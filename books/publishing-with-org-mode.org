...
[[/notes/shader-tests/whirlpool/][whirlpool note]] does exactly this.
...
[[/notes/shader-tests/whirlpool/][whirlpool shader note]], which shows the whole shader as a changeset
