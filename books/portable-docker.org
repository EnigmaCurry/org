...
#+attr_shortcode: :style secondary :title Run this on your Raspberry Pi
#+begin_run
sentry route set pi immich.pi.example.com
#+end_run
...
#+attr_shortcode: :style secondary :title Run this on your Raspberry Pi
#+begin_run
sentry route set pi www.pi.example.com
#+end_run
...
#+attr_shortcode: :style secondary :title Run this on your Raspberry Pi
#+begin_run
sentry route set pi s3.pi.example.com \
  --restart false
sentry route set pi s3-console.pi.example.com \
  --restart true
#+end_run
...
#+attr_shortcode: :style secondary :title Run this on your Raspberry Pi
#+begin_run
sentry route set pi filestash-test.pi.example.com
#+end_run
...
#+attr_shortcode: :style secondary :title Run this on your Raspberry Pi
#+begin_run
sentry route set pi nginx.pi.example.com
#+end_run
