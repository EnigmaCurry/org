 ...
 * You can upload files multiple files at a time by draging and
   dropping them directly from your computer's file manager into the
   browser window (FYI the dropzone is only near the top of the page).
