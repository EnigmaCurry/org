...
#+begin_notice
This might seem like a good idea, but there is currently a problem
with this configuration: everytime you restart Traefik and/or
WireGuard you will lose your connection. A [[https://github.com/EnigmaCurry/d.rymcg.tech/issues/312][backend channel]] that is
maintained outside of this configuration would make remote
adminstration more robust.
#+end_notice
