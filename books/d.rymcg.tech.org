...
Each scenario will build on the next, so you might consider following
them in order, but you can also skip straight to the one you want, as
each set of instructions is self-contained.
...
*** TODO Traefik Wireguard Layer 7 Proxy
:PROPERTIES:
:EXPORT_FILE_NAME: wireguard-server
:EXPORT_HUGO_WEIGHT: 6000
:END:
*** TODO Traefik Wireguard Layer 7 Client
:PROPERTIES:
