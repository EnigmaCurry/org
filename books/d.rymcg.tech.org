...
You need to install Docker Engine on your workstation
...
*** Use the generic Docker installer
...
where you put it, but watch out, as this may make the commands in this
documentation not work exactly as intended with your config, unless
you change =ROOT_DIR= in all *external* project Makefiles accordingly.
#+end_notice
...
to your current docker context.
#+end_notice
