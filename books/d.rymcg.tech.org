...
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :linkTitle Self-hosting Docker with d.rymcg.tech
:END:
...
* Create a Docker server on a VPS (DigitalOcean)
:PROPERTIES:
:EXPORT_FILE_NAME: public-docker-vps
:END:

This chapter will guide you to create your own public Docker server as
