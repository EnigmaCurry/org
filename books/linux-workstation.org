...
There are two versions of solokey now, v1 and v2. The instructions
diverge depending on which hardware revision you have.
...
the last known good version of 0.9.0, it will work:
