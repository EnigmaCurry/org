...
These instructions have been tested on Fedora Atomic and Arch Linux
workstations.
...
#+begin_notice
If you are running Fedora Atomic, this depends on the libvirt packages
installed in the chapter on [[/linux-workstation/layering-packages][Layering packages]].
#+end_notice
...
sudo pacman -S libvirt iptables-nft dnsmasq qemu-base virt-install \
               sysfsutils bridge-utils ebtables
#+end_run
