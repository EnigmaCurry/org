...
workstation's only purpose is to serve the user, during the moments that you are interfacing with its physical keyboard/display. A workstation /is/ usually connected to a network, but only
