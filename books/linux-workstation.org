...
#+attr_shortcode: :style orange :title Compatibility
#+begin_notice
These instructions have been tested as working on the following
Linux distributions:

 * ✅ Fedora Atomic (40)
 * ✅ Arch Linux

🚧 Debian (12) workstations are only partially compatible, I have not
been able to get the autostart service to run, due to an app armor
