...
#+attr_shortcode: :style warning
#+begin_notice
Fedora Atomic comes with good default workstation firewall rules, so theres
really nothing /required/ for you to do here. This chapter will mostly
discuss things you should /not/ change on a workstation, but is a
general guide to how things work, if the need should arise.
#+end_notice
...
#+attr_shortcode: :style tip
#+begin_notice
As long as you don't need multiple zones, it's recommended to always
use the =public= zone. But here is how you can switch zones if you
...
continue on, or press =Ctrl-C= to quit nc.
#+end_notice
