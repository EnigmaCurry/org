...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let MAX_ITER = 5;
    let SWIRL_FACTOR = 2.0; // Control the swirl intensity
    ...
    let mut chart = ChartBuilder::on(&root)
        ...
        .build_cartesian_2d(-1.5..1.5, -1.2..1.2)?; // Zoomed in view
